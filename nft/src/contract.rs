...
unsafe extern "C" fn handle() {
    ...
    match action {
        NFTAction::Mint {
            ...
            msg::reply(NFTEvent::Transfer(MyNFTCore::mint(nft, to, token_id, token_metadata)), 0)
                .expect("Error `NFTEvent::Transfer`");
        }
        // NFTAction::Burn {
        //     transaction_id,
        //     token_id,
...
impl MyNFTCore for Nft {
    fn mint(
        ...
        NFTCore::mint(self, &to, token_id, token_metadata)
    }
}
